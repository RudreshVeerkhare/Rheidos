...
- `VectorFieldView(vector_source, color_scheme="sequential", scale=1.0, thickness=2.0, visible_store_key=None, store=None, sort=0)`
- `ScalarFieldView(scalar_source, color_scheme="sequential", frame=(-1,1,-1,1), visible_store_key=None, store=None, sort=0)`
