...
The generated PNG/PDF plots intentionally contain no text labels, titles, tick labels, legend text, or inset text. The canvas keeps blank margins so labels can be overlaid later in LaTeX.
