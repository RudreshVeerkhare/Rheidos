...
- Interactive loop (suitable for notebooks or REPL):
  ...
  python rheidos/examples/run_interactive.py
...
- Studio (CAD-like) environment preview:
  ...
  python rheidos/examples/studio_preview.py

- Load a custom OBJ/PLY/STL file and preview it with glossy shading:

  python rheidos/examples/mesh_preview.py path/to/model.obj

- Additional flags:

  python rheidos/examples/mesh_preview.py path/to/model.obj --no-center
